        ...
        do {
            ...
            switch (task) {
                ...
                case 3:
                    ...
                    sportEquipmentService.edit(null); // Assuming the service handles the selection and editing
                    break;
                case 4:
                    System.out.println("----- Удаление товара -----");
                    sportEquipmentService.remove(null); // Assuming the service handles the selection and removal
                    break;
                case 5:
                ...
                case 7:
                    ...
                    clientService.edit(null); // Assuming the service handles the selection and editing
                    break;
                case 8:
                    System.out.println("----- Удаление клиента -----");
                    clientService.remove(null); // Assuming the service handles the selection and removal
                    break;
                case 9:
